...
class EmbeddingsService {
    ...
    static async generateEmbedding(text) {
        ...
        if (googleApiKey) {
            try {
                const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/text-embedding-004:embedContent?key=${googleApiKey}`, {
                    method: 'POST',
     ...
     */
    static generateLocalVector(text, dim) {
