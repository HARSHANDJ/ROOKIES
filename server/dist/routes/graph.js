...
router.get('/topology', (req, res) => {
    const documents = inMemoryStore_1.inMemoryStore.getDocuments();
    const chunks = inMemoryStore_1.inMemoryStore.getAllChunks();
    const nodes = [];
    const edges = [];
    ...
    edges.push({ id: 'e-t1-r1', source: 'top-attendance', target: 'rule-75-att', label: 'Mandates' }, { id: 'e-t1-r2', source: 'top-attendance', target: 'rule-80-honours', label: 'Amends' }, { id: 'e-t2-r3', source: 'top-appeals', target: 'rule-10d-appeal', label: 'Governs' }, { id: 'e-t3-r4', source: 'top-fines', target: 'rule-1d-fine', label: 'Assesses' }, { id: 'e-t4-r5', source: 'top-housing', target: 'rule-15-parking', label: 'Requires' });
